...
public:
    ...
    void print_array_decl(donsus_ast::array_decl &decl, int indent_level) {
        ...
        print_with_newline("number_of_elements: " + std::to_string(decl.number_of_elements), indent_level);
    };
    ...
    void print_array_def(donsus_ast::array_def &def, int indent_level) {
        ...
        print_with_newline("number_of_elements: " + std::to_string(def.number_of_elements), indent_level);
